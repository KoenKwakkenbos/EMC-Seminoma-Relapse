...
#SBATCH --gres=gpu:4         ### How many GPUs do you need?
#SBATCH -t 0-48:00:00        ### The time limit in D-hh:mm:ss format
#SBATCH -o /trinity/home/kkwakkenbos/repositories/EMC-Seminoma-Relapse/output_resnet_kfold/out_%j.log        ### Where to store the console output (%j is the job number)
#SBATCH -e /trinity/home/kkwakkenbos/repositories/EMC-Seminoma-Relapse/output_resnet_kfold/error_%j.log      ### Where to store the error output
#SBATCH --job-name=ResNet_classifier  ### Name your job so you can distinguish between jobs
...
echo "Training supervised classifier"
